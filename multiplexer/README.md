...
Она имеет 2 информационных входа, то есть $2^1$, 1 адресный вход SEL и один выход OUT. На адресный вход SEL приходит информация о том, какой из информационных входов IN1 или IN2 был выбран. Далее активируется нужный вход и данные с него поступают на выход. Как-то так работает мультиплексор
