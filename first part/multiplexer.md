...
А теперь, опираясь на вышеизложенную теорию, опишем данную схему на System Verilog. Есть несколько различных способов, которые позволят это сделать.  
...
Этот способ чем-то напоминает конструкцию if-else описанную в одну строчку  
...
<div align="center">
  <img width="349" height="369" alt="MUX_4_1_DATA_BLACK" src="https://github.com/user-attachments/assets/4f23bf86-2601-4d5f-9887-aabf9d94ffed" />
</div>

Теперь выходу нужно понимать, информацию с какого входа ему нужно брать. Для этого входам нужно дать какие-то названия, мы же не можем сказать: "Используем вход второй сверху и пред пред последний". В случае с мультиплексором 2 в 1, мы закодировали IN0 – 0, IN1 – 1. А если выхода 4 и мы работаем в двоичной системе счисления, то однобитного кодирования номера мультиплексора нам уже будет недостаточно. В таком случае:

<div align="center">
  <img width="349" height="369" alt="MUX_4_1_NAME_BLACK" src="https://github.com/user-attachments/assets/a07e7d4d-07af-498a-a95a-79686448b06d" />
</div>

Или же в двоичной:

<div align="center">
  <img width="349" height="369" alt="MUX_4_1_NAME_BIN_BLACK" src="https://github.com/user-attachments/assets/ff310b14-2419-46fe-8005-5c1c6e1fc07d" />
</div>

Соответственно, исходя из этой логики можно сказать, что сигнал выбора будет не однобитным. На System Verilog этот момент можно описать следующим образом:
